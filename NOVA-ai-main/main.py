...
class JarvisApp:
    ...
    def start(self):
        ...
        try:
            ...
            # Launch desktop_1.py without blocking
            print("Launching Desktop 1...")
            subprocess.Popen(["python", desktop_1_path])
            
            # Allow desktop_1.py some time to initialize
            time.sleep(2)
            
            # Launch desktop_2.py
            print("Launching Desktop 2...")
            subprocess.Popen(["python", desktop_2_path])
