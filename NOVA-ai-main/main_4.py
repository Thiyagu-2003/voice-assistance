...
from new_d_1 import InfoDialog, JarvisGUI
from PyQt5.QtWidgets import QApplication
from PyQt5 import QtCore
from new_d_2 import JarvisOverlayGUI
...
def listen_command():
    ...
    try:
        ...
        window.TerminalText(f"You said: {command}\n")
        return command
...
class JarvisApp:
    ...
    def start(self):
        ...
        try:
            ...
            desktop_1_path = "D:\\FINAL_YEAR_PROJECT\\voice-assistance\\NOVA-ai-main\\new_d_1.py"
            desktop_2_path = "D:\\FINAL_YEAR_PROJECT\\voice-assistance\\NOVA-ai-main\\new_d_2.py"
